...
namespace SURVEYllance.Manager
{
    ...
    public class CreatorManager
    {
        ...
        public Survey NewSurvey(string connectionId, Survey survey)
        {
            ...
            survey.OnVotesChange += (pSurvey, pAnswer) =>
            {
                _creatorHubContext.Clients.Client(room.Creator).SendAsync("OnNewSurveyResult", pSurvey.Id, pAnswer);
            };
